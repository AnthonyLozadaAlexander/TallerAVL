...
public class Main {
	public static void main(String[] args) {
		...
		avl.eliminar(persona);

		System.out.println("Tiempo De Busqueda De Nodo Existente: " + (finalBuscar - inicioBuscar) + "[Ns]");
		System.out.println("Tiempo De Busqueda De Nodo No Existente: " + (finalBuscarNoExistente - inicioBuscarNoExistente) + "[Ns]");
